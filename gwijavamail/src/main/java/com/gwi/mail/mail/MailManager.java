...
public class MailManager {
    private static MailManager ourInstance = new MailManager();
    ...
    public void sendMimeMail(String[] receiveMail, String content) throws Exception {
        ...
        props.setProperty("mail.host", GwiConfigs.Mail.SEND_EMAIL_SMTPHOST);    // 发件人的邮箱的 SMTP 服务器地址
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, GwiConfigs.Mail.SEND_EMAIL_ACCOUNT, receiveMail, content);
        ...
        transport.connect(GwiConfigs.Mail.SEND_EMAIL_ACCOUNT, GwiConfigs.Mail.SEND_EMAIL_PASSWORD);
