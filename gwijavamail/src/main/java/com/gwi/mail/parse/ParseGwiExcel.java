 ...
 */
public abstract class ParseGwiExcel extends Parse implements IParse {

    abstract void readExcelFile(String filePath);

    protected void creatEntity(ExcelEntity entity, String columnLabel, String outPut) {
        switch (columnLabel) {
    ...
    protected boolean filterColumns(String outPut) {
     ...
     * @return
     */
    protected void getAbnormalJobNomber(ArrayList<ExcelEntity> list) {
        mHashMap.clear();
    ...
    protected boolean checkDate(String time) {
    ...
    protected StringBuffer getContent(String tips, String jobNomber, String date, String time) {
        StringBuffer sb = new StringBuffer();
